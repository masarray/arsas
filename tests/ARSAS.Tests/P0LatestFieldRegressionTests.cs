...
public sealed class P0LatestFieldRegressionTests
{
    ...
    [Fact]
    public void CommandDefaults_RegisterAtModuleLoadAndStartInterlockAndSyncChecked()
    {
        ...
        Assert.DoesNotContain("P0CommandDefaultsClassHandlerRegistered", source, StringComparison.Ordinal);
    }
    ...
    [Fact]
    public void MultiRcbExport_ProductionClickCannotFallThroughToLegacySingleSelect()
    {

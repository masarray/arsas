...
public sealed class SntpPacketTests
{
    ...
    public void ClientRequest_IsRecognized_AndReplyCopiesVersionPollAndOriginateTimestamp()
    {
        ...
        Assert.Equal(SntpServerProfile.GenericIedCompatibilityStratum, reply[1]);
    ...
    [Fact]
    public void Broadcast_IsMode5_AndUsesGenericIedCompatibilityStratum()
    {
        ...
        Assert.Equal((byte)2, SntpServerProfile.GenericIedCompatibilityStratum);
        Assert.Equal(SntpServerProfile.GenericIedCompatibilityStratum, packet[1]);

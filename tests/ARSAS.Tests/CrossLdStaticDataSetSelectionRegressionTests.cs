...
public sealed class CrossLdStaticDataSetSelectionRegressionTests
{
    [Fact]
    public void Synthetic_58Member_CrossLd_StaticDataSets_AreRepresented58Of58()
    {
        var model = SclLiveModelProjectionBuilder.Build(BuildFixture(), "CrossLd_58_member.cid");
    ...
    [Fact]
    public void Synthetic_58Member_CrossLd_StaticDataSets_Survive_Real_SclMapper_Path()
    {
        var model = SclLiveModelProjectionBuilder.Build(BuildFixture(), "CrossLd_58_member.cid");
    ...
    private static XDocument BuildFixture()
    {
        ...
        return new XDocument(
            new XElement(ns + "SCL",
                ...
                new XElement(ns + "Header", new XAttribute("id", "ARSAS_CROSS_LD_58")),
                new XElement(ns + "IED",

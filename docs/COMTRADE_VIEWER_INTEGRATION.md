...
ARSAS/
  ...
  Tools/
    ArdIrec/
      ...
      ardirec.exe          # P0 compatibility fallback
      Qt6*.dll
      qml/
      plugins/
      ...windeployqt runtime...
...
8. Installer smoke validation requires `ardirec_bridge.dll` as an installed product component.
9. Production release provenance records the exact ArdIrec repository/commit used to build both native and compatibility paths.

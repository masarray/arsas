...
public partial class MainWindow
{
    private void BuildDemoGooseWorkspace()
    {
        GooseAdapters.ReplaceAll(new[]
        {
            ...
            {
                Index = 1,
                Name = "demo://station-bus",
                FriendlyName = "Station Bus VLAN 100 (Synthetic)",
                Description = "ArIED built-in demonstration adapter",
                MacAddress = "02:00:5E:61:85:00"
            }
        });
        SelectedGooseAdapter = GooseAdapters[0];
        IsGooseCapturing = true;
        GooseBindingText = "DEMO model binding • 6 publishers • ordered DataSet leaves resolved from synthetic IED models";
        GooseStatusText = "DEMO • synthetic read-only GOOSE capture is running; no Ethernet frames are transmitted or received.";

        var streamSpecs = new[]
        {
            DemoGooseSpec("gcb-incomer", "BCU_INCOMER_150KV", "0x1001", "01:0C:CD:01:00:01", 100, "gcbTripStatus", "dsTripStatus",
            ...
            DemoGooseSpec("gcb-linediff", "PROT_LINE_DIFF_L01", "0x1101", "01:0C:CD:01:01:01", 110, "gcbLineProtection", "dsLineProtection",
                ...
                ("Breaker position", "XCBR1.Pos.stVal", "DPC / Dbpos", "Closed [10]")),
            DemoGooseSpec("gcb-trafodiff", "PROT_TRAFO_DIFF_TR1", "0x1201", "01:0C:CD:01:02:01", 120, "gcbTransformerTrip", "dsTransformerTrip",
            ...
            DemoGooseSpec("gcb-busbar", "PROT_BUSBAR_DIFF_BB1", "0x1301", "01:0C:CD:01:03:01", 130, "gcbBusbarTrip", "dsBusbarTrip",
            ...
            DemoGooseSpec("gcb-coupler", "BCU_BUS_COUPLER_150KV", "0x1401", "01:0C:CD:01:04:01", 140, "gcbCouplerInterlock", "dsCouplerInterlock",
            ...
            DemoGooseSpec("gcb-feeder", "PROT_OCR_FEEDER_F01", "0x1501", "01:0C:CD:01:05:01", 150, "gcbFeederProtection", "dsFeederProtection",
    ...
    private void BuildDemoDiagnostics()
    {
        ...
        {
            new() { Time = now.AddMinutes(-8), Level = "INFO", Source = "Demo", Message = "Synthetic substation workspace initialized. Network transport is disabled." },
            new() { Time = now.AddMinutes(-7.8), Level = "INFO", Source = "MMS", Message = "10 independent IEC 61850 associations established on TCP/102 (synthetic)." },
            ...
            new() { Time = now.AddMinutes(-1.2), Level = "INFO", Source = "Reporting", Message = "Periodic integrity report completed for PROT_TRAFO_DIFF_TR1; 12 values confirmed good." }
        };
        Logs.AddRange(logs);
    }
}

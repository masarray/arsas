...
public partial class IoListTestingWindow
{
    ...
    private void InstallAuthoritativeFatLiveValueColumn()
    {
        ...
        // Virtualization is owned by the baseline XAML. Never change VirtualizationMode or
        // IsVirtualizing from Loaded/Measure-time recovery code.
...
/// <summary>
/// Event-driven FAT cell that resolves the live monitor point already proven by FAT binding.
/// The monitor/report process image is authoritative; the Engineering control cache and FAT
/// runtime image are fallbacks only. This cell performs no protocol read and mutates no FAT
/// evidence or acquisition policy.
/// </summary>

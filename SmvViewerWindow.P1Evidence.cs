...
public partial class SmvViewerWindow
{
    ...
    private byte[] RenderWaveformPng()
    {
        ...
        var width = Math.Max(1, (int)Math.Ceiling(Math.Max(WaveformCanvas.ActualWidth, WaveformCanvas.Width)));
        ...
        using (var drawing = visual.RenderOpen())
        {
            ...
            drawing.DrawRectangle(new VisualBrush(WaveformCanvas), null, bounds);
        }
